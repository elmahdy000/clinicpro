...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex field-sizing-content min-h-12 w-full rounded-xl border border-slate-200 bg-white px-4 py-2 text-right text-sm leading-7 text-slate-900 placeholder:text-slate-400 shadow-sm transition",
