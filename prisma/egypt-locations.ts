...
export async function seedEgyptLocations(prisma: PrismaClient) {
  console.log("Seeding Egypt Governorates and Cities...");
  ...
  console.log("Egypt Governorates and Cities Seeding Completed.");
}
